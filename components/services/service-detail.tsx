...
export default function ServiceDetail({ id, title, description, fullDescription, benefits }: ServiceDetailProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-accent font-semibold mb-4">{description}</p>
            <p className="text-muted-foreground leading-relaxed mb-8">{fullDescription}</p>
          ...
          {/* Right Benefits */}
          <div>
            <h3 className="text-2xl font-bold text-foreground mb-8">Avantages clés</h3>
